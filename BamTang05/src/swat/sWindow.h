...
protected:
    ...
    cRect m_wCurrentRect;               // Guardamos los actuales: Area de rectangulo de la ventana. Al terminar de crear la ventana.
    cRect m_wInitRect;		            // Guardamos los iniciales, para recuperar despues de pantalla completa.
    ...
    int setWindowSettings(sCreaVentana* ptVentana, cRect* ptWindowRect);
    int	setWindowStyles(sCreaVentana* ptVentana, cRect* ptWindowRect);
